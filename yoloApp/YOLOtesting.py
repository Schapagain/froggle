...
for image in os.listdir(f"{prediction_dir}/TestImages2/"):
    ...
    validation_results = model.predict(source=image_path, classes=[0, 1], project=prediction_dir, agnostic_nms=True, conf=0.25, max_det=500, save=False, save_txt=True, save_conf=True, show_labels=False, show_conf=False, show_boxes=True, line_width=3, exist_ok=True)
