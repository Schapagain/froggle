...
app_ui = ui.page_fluid(
    ui.layout_sidebar(
        ui.panel_sidebar(
            ui.input_file("image_zip", "Choose a ZIP file with images", multiple=False, accept=['.zip'], placeholder='No file selected', width='100%'),
            ui.input_action_button("process_button", "Run YOLO model", width='150px')
        ),
        ui.panel_main(
